...
class ChatWriterThread(QThread):
    ...
    def run(self):            
        with self.get_chromedriver(
            ...
            try:
                element = self.driver.find_element(By.XPATH, '//*[@id="Header"]/section/div[3]/div/div[2]/div[2]')
                points = element.text
                ...
                send_telegram_message(bot_token, chat_id, f'Аккаунт {self.account_name} не нашел поинты.')
